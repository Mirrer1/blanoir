  ...
  return (
    <section className="relative flex min-h-[100dvh] flex-col justify-end overflow-hidden px-6 pt-24 pb-10 text-white">
      ...
      <div className="relative mx-auto flex w-full max-w-5xl flex-col gap-10 md:flex-row md:items-end md:justify-between md:gap-16">
        <h1 className="font-heading animate-in fade-in-0 slide-in-from-bottom-6 block text-6xl leading-none font-extrabold tracking-tight duration-700 ease-out sm:text-7xl md:text-8xl lg:text-9xl">
          Blanoir
        </h1>

        <div className="animate-in fade-in-0 slide-in-from-bottom-6 flex max-w-xl flex-col gap-6 delay-150 duration-700 ease-out md:items-end md:text-right">
          <p className="text-sm leading-7 break-keep text-white/85 sm:text-base">
            클릭만으로, 5분이면 충분해요. 포트폴리오, 매장 소개, 청첩장까지 코딩을 몰라도 클릭만으로
            만들고 바로 공개하세요.
          </p>
